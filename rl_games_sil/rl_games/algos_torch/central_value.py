# SPDX-FileCopyrightText: Copyright (c) 2019 Denys88.
...
class CentralValueSILTrain(CentralValueTrain):
    ...
    def get_sil_value(self, input_dict):
        ...
        obs_batch = self._preproc_obs(obs_batch)
        res_dict = self.forward(
            {"obs": obs_batch, "actions": actions, "rnn_states": self.sil_rnn_states, "is_train": False}
        )
    ...
    def train_sil_net(self):
        ...
        if self.writter is not None and self.sil_coef != 0:
